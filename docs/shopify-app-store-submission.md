...
- Do not claim live publishing unless an eBay API result confirms a live/publishable listing.
- Do not imply Etsy, Vinted, Depop, Facebook Marketplace, Gumtree, or other direct integrations.
- Do not describe QST Desktop as required.
- Do not use unverified time-saving, sales, or performance statistics.

## Required setup before submission
