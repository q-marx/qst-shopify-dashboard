...
Sell a small done-for-you service while QST is still being prepared for Shopify App Store review:

```text
QST Listing Rescue
I turn product links, Shopify exports, or spreadsheets into marketplace-ready listing packs.
```

Public link after Render deploys:
...
- Small Shopify stores with products but weak titles/descriptions.
- Etsy sellers with handmade items and inconsistent tags.
- eBay sellers relisting old products.
- Local Facebook Marketplace sellers with multiple items.
- Makers/crafters already posting product photos but not getting sales.

## Outreach Message

```text
Hi, I noticed you have products that could also work well on eBay/Etsy/Facebook Marketplace.
...
```text
I am opening a few slots for a practical product-listing cleanup service.

If you sell handmade, decor, gifts, clothing, or collectibles and want to push products onto eBay, Etsy, Facebook Marketplace, Vinted, Depop, or Gumtree, send me your product links.
